package com.fARmework.Creativity.SoundIndicator._impl;

import android.content.*;
import android.media.*;
import android.media.SoundPool.OnLoadCompleteListener;

import com.fARmework.Creativity.SoundIndicator.*;
...
public class SoundPlayer implements ISoundPlayer
{
	...
	public SoundPlayer(Context context, int initialDelay)
	{
		_delay = initialDelay;
